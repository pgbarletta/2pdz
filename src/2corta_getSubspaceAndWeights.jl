...
# Get ready
home = "/scratch/pbarletta/22pdz/"
neq = "run/lb/neq/";
natoms = 2076;
natoms_22pdz = 1944;
natoms_lig = natoms - natoms_22pdz;
...
for paso = 1:2000
    ...
    for frame=1:frame_cnt
        ...
        # Obtengo el vector diferencia normalizado de los Calpha no_loop del 22pdz entre el frame y el avg
